...
model.fit_generator(data_gen(filter(lambda x: x != args.v, range(10)), BATCH_SIZE, args.alu),
...
# evaluation
xy = xy_gen()
y_pred = model.predict_generator(xy.x_gen([args.v], BATCH_SIZE, args.alu), val_samples=N_VAL_SAMPLES)
